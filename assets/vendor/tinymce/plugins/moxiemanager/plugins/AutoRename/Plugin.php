...
class MOXMAN_AutoRename_Plugin implements MOXMAN_IPlugin {
	...
	public function renameFile(MOXMAN_Vfs_IFile $file) {
        ...
        $languageSpecific = isset($languageSpecific[$language]) ? $languageSpecific[$language] : null;

        if (! is_null($languageSpecific)) {
            $title = str_replace($languageSpecific[0], $languageSpecific[1], $title);
        }
        ...
        $name = trim($title, $separator);
        /*------------------------------------------------------------------*
         * END AUTO REMOVE VIETNAMSES
         *------------------------------------------------------------------*/
